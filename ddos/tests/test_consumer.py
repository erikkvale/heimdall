...
from ..consumer import ApacheParserException, ApacheLogRecord, parse_apache_log_record, get_suspect_ips
...
def test_quarantine_ip_address():
    apache_log_records = [
    ...
    suspect_ips = get_suspect_ips(counter, request_threshold=3)
